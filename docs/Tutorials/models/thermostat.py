...
class thermostat:
	...
	def __init__(self,obj): # this links the thermostat to the house
		self.Tair = gldcore.property(obj,"air_temperature")
		self.Theat = gldcore.property(obj,"heating_setpoint")
		self.Tcool = gldcore.property(obj,"cooling_setpoint")
		self.mode = gldcore.property(obj,"system_mode")
		self.deadband = gldcore.property(obj,"thermostat_deadband").get_value()
...
def setup(obj,t): # called to set up a new thermostat in a house
	...
	gldcore.set_value(obj,"thermostat_control",'NONE'); # disable the internal thermostat
	return 0 # setup ok
def update(obj,t):
