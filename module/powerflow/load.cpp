	...
	if(oclass == NULL)
	{
		...
		if(gl_publish_variable(oclass,
			...
			PT_enumeration, "load_class", PADDR(load_class),
				PT_DEFAULT, "U",
				PT_DESCRIPTION,"Flag to track load type--used by some subclasses of load",
				...
				PT_KEYWORD, "T", (enumeration)LC_TRANSPORTATION,
				PT_KEYWORD, "P", (enumeration)LC_PUBLICSERVICE,
