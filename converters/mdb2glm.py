...
def help():
    print("Syntax:")
    print(
        "mdb2glm.py -i|--ifile <input-file> -o|--ofile <output-file> -t|--type <input-type> -f|--format <output-type>"
    )
...
if not input_type:
    print(
        "ERROR    [mdb2glm.py]: conversion type not specified (-t <type> option is missing)"
    )
    sys.exit(5)
if output_type:
